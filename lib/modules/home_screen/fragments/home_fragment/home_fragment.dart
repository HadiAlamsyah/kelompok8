...
class _HomeFragmentState extends State<HomeFragment> {
  ...
  final List<News> newsList = [
    News(
      id: '1',
      title: 'Tangis Anies Baswedan Lepas Kepergian M Taufik',
      content:
          'Merdeka.com - Mantan Gubernur DKI Jakarta Anies Baswedan mengatakan, almarhum mantan Wakil Ketua DPRD M Taufik adalah orang yang konsisten. Dia juga melihat Taufik sebagai orang yang tidak takut menghadapi konsekuensi atas tindakan yang dibuatnya',
      imagePath:
